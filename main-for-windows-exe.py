...
MOM_IMAGE_PATH  = get_asset_path("assets/mom.png")          # e.g. "C:/Users/Asus/Pictures/mom.png"
SCARE_SOUND_PATH = get_asset_path("assets/scare.mp3")   # e.g. "C:/Users/Asus/Music/scare.mp3"
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
try:
    ...
    print(f"⚠️  Mom image not found ({e}) — using placeholder drawing instead.")

try:
    scare_sound = pygame.mixer.Sound(SCARE_SOUND_PATH)
    print("✅ Jumpscare sound loaded!")
except Exception as e:
    print(f"⚠️  Jumpscare sound not found ({e}) — will run silently.")
